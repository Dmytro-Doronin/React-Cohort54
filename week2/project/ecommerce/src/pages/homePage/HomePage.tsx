...
import {getAllProducts, getProductsForSingleCategory} from "../../api/products/products-api.ts";
...
export const HomePage = () => {
    ...
    }, [allProducts, currentCategory, getAllProductsRequest, getProductsForSingleCategoryRequest])
    ...
    const productLoading = isAll ? allProductsLoading : productsForSingleCategoryLoading
